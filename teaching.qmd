...
- **Global Development: Intermediate Topics in Politics, Policy, and Data**
    ...
    - Lecturer, Spring 2026. \[[Course Materials](https://carolina-torreblanca.github.io/psci3200-globaldev-main/){target="_blank"}\]\[[Course Evaluations](/files/course_evals/dev2.pdf){target="_blank"}\]
...
-   **Political Theory** **(Undergraduate)**
    ...
    -   TA for Professor Dimitri Landa, Fall 2020. \[[Course Evaluations](/files/course_evals/poltheory.pdf){target="_blank"}\]
