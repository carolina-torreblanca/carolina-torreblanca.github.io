...
<p><em>Perspectives on Politics (forthcoming)</em></p>
::: {.abstract}
<p>
...
<p><strong>The Demobilizing Effect of Selective Exposure and Heterogeneous Responses to Violence</strong><br /> \[[paper](/files/papers/crime/paper.pdf){target="_blank"}\]\[[appendix](/files/papers/crime/Appendix.pdf){target="_blank"}\]</p>
<p><em>Honorable Mention for the APSA Comparative Politics Section Sage Best Paper Award (2024)</em></p>

::: {.abstract}
<p>

The burden of violence is not shared equally. Yet, our understanding of its consequences often comes from populations unlikely to be victimized. Using principal stratification, I show that because exposure to violence is selective and reactions to it are heterogeneous, effects among the exposed can differ from the population average. Empirically, I reassess the mobilization-spurring consequences of crime. Recovering all causal effects consistent with victimization and participation rates across 94 surveys in 20 Latin American countries, I show population-wide average effects favor mobilization. Conversely, effects among victims are overwhelmingly negative. Panel evidence from Mexico confirms that those likely to demobilize are more exposed to crime. Similar reversals arise when reassessing civil war abduction in Uganda and police contact in the United States. Where selective exposure and heterogeneous reactions coincide, the effect among the exposed is the causal quantity of interest. Targeting this effect reveals that violence likely demobilizes those exposed.
...
::: {.abstract}
<p>
Trust in police is a critical input in the co-production of public security. We show that the positive socioeconomic status (SES)-trust in police gradient observed in the US does not generalize to Latin America. In 146 surveys spanning 20 countries, we find that trust in police is weakly and negatively correlated with SES—a fact that neither regional nor subject-matter experts anticipated. We propose that rich citizens are more likely to interpret everyday experiences as signals about the police. Because bad experiences like crime victimization and bribe solicitation are more common in Latin America than in the US, rich citizens' tendency to interpret poor security outcomes as signals of police untrustworthiness leads to a lower trust–
SES gradient. In our account, cross-country differences in the trust–SES gradient are driven by differences in policing outcomes coupled with universal class-based differences in people's readiness to see the world around them as signals about police.
</p>
:::
